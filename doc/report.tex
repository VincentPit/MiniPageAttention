...
To ground the discussion, I reimplemented a teaching version of PagedAttention from scratch, including a custom paged-decode Triton kernel modelled on vLLM's \texttt{paged\_attention\_v2} CUDA launcher~[5].\footnote{Source: \url{https://github.com/VincentPit/MiniPageAttention}} Several of the critiques below were prompted by integration friction that is invisible at the paper level but loud at the implementation level.
